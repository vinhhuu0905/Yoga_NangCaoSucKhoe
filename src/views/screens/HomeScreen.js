    ...
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View
          ...
          <View style={{flex: 1}}>
            <Text style={style.headerTitle}>Yoga là chìa khoá</Text>
            <Text style={style.headerTitle}>là suối dòng của tuổi trẻ. Bạn chỉ có thể trẻ mãi khi xương cốt của mình dẻo dai.</Text>
        ...
        <View>
          ...
          />
          <Text style={style.sectionTitle}>Yoga cho những người bắt đầu</Text>
          <FlatList
        ...
        <View>
        <Text style={style.sectionTitle}>Yoga dành cho bà bầu</Text>
          <FlatList
            snapToInterval={width - 20}
            contentContainerStyle={{paddingLeft: 20, paddingBottom: 20}}
            showsHorizontalScrollIndicator={false}
